...
// CONCATENATED MODULE: ./components/User/Permissions.js
...
function (_React$Component) {
  ...
  function UserPermissions() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handlePermissionChange", function (e) {
      var checkbox = e.target; // current permissions

      var updatedPermissions = _toConsumableArray(_this.state.permissions); // remove or add this permission
  ...
  _createClass(UserPermissions, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
        ...
        }), external_react_default.a.createElement("td", null, external_react_default.a.createElement(Button["b" /* FormButton */], {
          type: "button",
          disabled: loading,
...
/* harmony default export */ var User_Permissions = (Permissions_Permissions);
...
var permissions_PermissionsPage = function PermissionsPage(props) {
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(SigninWarning["a" /* default */], null, external_react_default.a.createElement(User_Permissions, null)));
};
