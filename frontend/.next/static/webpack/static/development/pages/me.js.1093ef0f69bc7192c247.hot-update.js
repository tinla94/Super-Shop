...
})(["width:100%;margin-top:2rem;color:", ";h2{text-align:center;font-size:3.5rem;letter-spacing:.5rem;}hr{margin:0 10% 1rem 10%;border-top:3px solid ", ";}.account-grid{display:grid;grid-template-columns:1fr 1fr;grid-gap:2rem;margin:0 10% 1rem 10%;img{width:100%;height:auto;border-radius:.4rem;box-shadow:2px 2px 2px rgba(0,0,0,0.5);}p{font-size:2rem;color:black;margin-bottom:1rem;text-decoration:underline;font-style:italic;}span{text-decoration:none !important;font-style:normal;}}"], function (props) {
...
//# sourceMappingURL=me.js.1093ef0f69bc7192c247.hot-update.js.map