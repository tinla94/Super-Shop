...
})(["width:100%;margin-top:2rem;color:", ";h2{text-align:center;font-size:3.5rem;letter-spacing:.5rem;}hr{margin:0 10% 1rem 10%;border-top:3px solid ", ";}.account-grid{display:flex;flex-direction:row;img{width:100%;height:auto;border-radius:.4rem;box-shadow:2px 2px 2px rgba(0,0,0,0.5);}p{font-size:2rem;margin-bottom:1rem;font-weight:600;letter-spacing:.2rem;.account-detail{font-style:italic;color:", ";}}}"], function (props) {
...
//# sourceMappingURL=me.js.6cc53653afcc70c5cf57.hot-update.js.map