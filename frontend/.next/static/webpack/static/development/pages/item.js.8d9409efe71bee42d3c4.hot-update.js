...
})(["width:100%;.singleitem-top{display:flex;align-items:center;padding:2rem 5rem 0 5rem;&-details{margin-left:3rem;}&-buttons{width:100%;padding:1rem 0;span{margin-right:2.5rem;font-size:2rem;cursor:pointer;&:hover{color:", ";}}}img{width:50%;height:auto;border:1px solid black;box-shadow:2px 2px 2px rgba(0,0,0,0.5);border-radius:.5rem;}.singleitem-bottom{padding:5rem 5rem 0 5rem !important;font-size:2rem;}"], function (props) {
...
//# sourceMappingURL=item.js.8d9409efe71bee42d3c4.hot-update.js.map