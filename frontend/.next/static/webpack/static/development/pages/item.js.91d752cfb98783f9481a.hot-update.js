...
})(["width:100%;.singleitem-top{display:flex;align-items:center;padding:2rem 5rem 0 5rem;&-details{margin-left:3rem;}&-buttons{width:100%;padding:1rem 0;}}img{width:50%;height:auto;border:1px solid black;box-shadow:2px 2px 2px rgba(0,0,0,0.5);border-radius:.5rem;transition:all .3s;&:hover{transform:scale(1.2);}}span{margin-right:2.5rem;font-size:2rem;cursor:pointer;&:nth-child(1){color:", "}&:nth-child(2){color:", "}&:nth-child(3){color:", "}&:hover{color:", ";}}.singleitem-bottom{padding:5rem 5rem 0 5rem !important;font-size:2rem;letter-spacing:.2rem;h3{font-size:3rem;letter-spacing:.4rem;}}"], function (props) {
...
//# sourceMappingURL=item.js.91d752cfb98783f9481a.hot-update.js.map