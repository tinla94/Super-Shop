...
})(["width:100%;.singleitem-top{display:flex;align-items:center;padding:2rem 5rem 0 5rem;&-details{margin-left:3rem;}&-buttons{width:100%;padding:1rem 0;}}img{width:50%;height:auto;border:1px solid black;box-shadow:2px 2px 2px rgba(0,0,0,0.5);border-radius:.5rem;}span{margin-right:2.5rem;font-size:2rem;cursor:pointer;&:nth-child(1){color:", "}&:nth-child(2){color:", "}&:nth-child(3){color:", "}&:hover{color:", ";}}.singleitem-bottom{padding:5rem 5rem 0 5rem !important;font-size:2rem;h3{font-size:3rem;letter-spacing:.4rem;}}"], function (props) {
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Header_Header__WEBPACK_IMPORTED_MODULE_1__["default"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(SingleItemStyles, {
          ...
          __self: this
        }, item.user), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
...
//# sourceMappingURL=item.js.bd6b287cf6a090c2b41b.hot-update.js.map