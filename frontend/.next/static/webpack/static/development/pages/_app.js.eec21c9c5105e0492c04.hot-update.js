...
})([".bar{border-bottom:10px solid  ", ";display:grid;grid-template-column:auto 1fr;justify-content:space-between;align-items:stretch;@media (max-width:1300px){grid-template-columns:1fr;justify-content:center;}}.sub-bar{display:grid;grid-template-columns:1fr auto;border-bottom:1px solid  ", "}"], function (props) {
...
//# sourceMappingURL=_app.js.eec21c9c5105e0492c04.hot-update.js.map